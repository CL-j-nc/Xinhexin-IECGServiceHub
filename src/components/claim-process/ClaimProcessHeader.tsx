...
const STATE_STYLES: Record<ClaimProcessState, string> = {
    [ClaimProcessState.PENDING_REVIEW]: 'bg-slate-100 text-slate-600 border-slate-200',
    ...
    [ClaimProcessState.PENDING_APPROVAL]: 'bg-cyan-50 text-cyan-700 border-cyan-100',
    ...
    [ClaimProcessState.PAID]: 'bg-teal-50 text-teal-700 border-teal-100'
};
